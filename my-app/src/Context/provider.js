...
const AppProvider = ({children}) =>{
    ...
    const fetchTasks = async() => {
        const incomingTasks = await fetch(`https://to-do-list-five-jade.vercel.app/api/task/fetchtasks`,{
            method: 'GET',
            headers: {
    ...
    const addNewTask = async (e) => {
        e.preventDefault()
        await fetch(`https://to-do-list-five-jade.vercel.app/api/task/addtasks`,{
            method: "POST",
            headers: {
                "Content-Type":'application/json',
                "auth-token":localStorage.getItem('auth-token')
    ...
    const deleteTask = async (e,noteId) =>{
        ...
        await fetch(`https://to-do-list-five-jade.vercel.app/api/task/deletetasks/${noteId}`,{
            method: "DELETE",
            headers: {
                "Content-Type":'application/json',
                "auth-token":localStorage.getItem('auth-token')
    ...
    const updateTask = async (e,noteId) => {
        ...
        await fetch(`https://to-do-list-five-jade.vercel.app/api/task/updatetasks/${noteId}`,{
            method: "PATCH",
            headers: {
                "Content-Type":'application/json',
                "auth-token":localStorage.getItem('auth-token')
    ...
    const fetchUser = async() => {
        const user = await fetch(`https://to-do-list-five-jade.vercel.app/api/auth/getuser`,{
                method: 'GET',
                headers: {
                    "Content-Type":'application/json',
                    "auth-token":localStorage.getItem('auth-token')
    ...
    const register = async (e) => {
        e.preventDefault();
        const user = await fetch(`https://to-do-list-five-jade.vercel.app/api/auth/register`,{
            method: "POST",
            headers: {
                "Content-Type":'application/json'
            },
    ...
    const login = async (e) => {
        e.preventDefault()
        const user = await fetch(`https://to-do-list-five-jade.vercel.app/api/auth/login`,{
            method: 'POST',
            headers: {
                "Content-Type":'application/json'
            },

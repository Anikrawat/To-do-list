...
const AppProvider = ({children}) =>{
    ...
    const fetchTasks = async() => {
        const incomingTasks = await fetch(`${window.location.protocol}//${window.location.host}/api/task/fetchtasks`,{
            method: 'GET',
            headers: {
    ...
    const addNewTask = async (e) => {
        e.preventDefault()
        await fetch(`${window.location.protocol}//${window.location.host}/api/task/addtasks`,{
            method: "POST",
            headers: {
                "Content-Type":'application/json',
                "auth-token":localStorage.getItem('auth-token')
    ...
    const deleteTask = async (e,noteId) =>{
        ...
        await fetch(`${window.location.protocol}//${window.location.host}/api/task/deletetasks/${noteId}`,{
            method: "DELETE",
            headers: {
                "Content-Type":'application/json',
                "auth-token":localStorage.getItem('auth-token')
    ...
    const updateTask = async (e,noteId) => {
        ...
        await fetch(`${window.location.protocol}//${window.location.host}/api/task/updatetasks/${noteId}`,{
            method: "PATCH",
            headers: {
                "Content-Type":'application/json',
                "auth-token":localStorage.getItem('auth-token')
    ...
    const fetchUser = async() => {
        const user = await fetch(`${window.location.protocol}//${window.location.host}/api/auth/getuser`,{
                method: 'GET',
                headers: {
                    "Content-Type":'application/json',
                    "auth-token":localStorage.getItem('auth-token')
    ...
    const register = async (e) => {
        e.preventDefault();
        const user = await fetch(`${window.location.protocol}//${window.location.host}/api/auth/register`,{
            method: "POST",
            headers: {
                "Content-Type":'application/json'
            },
    ...
    const login = async (e) => {
        e.preventDefault()
        const user = await fetch(`${window.location.protocol}//${window.location.host}/api/auth/login`,{
            method: 'POST',
            headers: {
                "Content-Type":'application/json'
            },
